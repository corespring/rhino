...
import org.corespring.javascript.debug.Debugger;
import org.corespring.javascript.xml.XMLLib;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(org.corespring.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "org.corespring.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "org.corespring.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(org.corespring.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see org.corespring.javascript.ErrorReporter
     */
     ...
     * @see org.corespring.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (org.corespring.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.corespring.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "org.corespring.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "org.corespring.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "org.corespring.javascript.regexp.RegExpImpl");
            if (cl != null) {
