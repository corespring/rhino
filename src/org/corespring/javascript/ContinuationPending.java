...
/**
 * Exception thrown by
 * {@link org.corespring.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link org.corespring.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link org.corespring.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link org.corespring.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link org.corespring.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link org.corespring.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link org.corespring.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
