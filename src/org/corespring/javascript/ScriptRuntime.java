...
import org.corespring.javascript.v8dtoa.FastDtoa;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("org.corespring.javascript.Context"),
        ContextFactoryClass
            = Kit.classOrNull("org.corespring.javascript.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("org.corespring.javascript.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("org.corespring.javascript.ScriptableObject");
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "org.corespring.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Packages",
                "org.corespring.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "getClass",
                "org.corespring.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "JavaAdapter",
                "org.corespring.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(scope, "JavaImporter",
                "org.corespring.javascript.ImporterTopLevel", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "org.corespring.javascript.NativeContinuation", sealed, true);
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "org.corespring.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "org.corespring.javascript.resources.Messages";
